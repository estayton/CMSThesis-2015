...
use my wrists and sometimes I lay my whole arm across.''\cite[p. 10]{dieboldImpact} And yet,
despite the meniality of his labor, it is still integral to the
process of production: without it, the line would grind to a halt. He
...
%% Noble cites 330, 330
In truth, automation may look very different depending on where in the hierarchy
...
computing power), there are a number of approaches to AI research, different
...
history is presently unappreciated outside of the discipline. 
...
natural-language interface makes it appear more eerily sci-fin than it
actually is.
...
automation? These are questions to which we will return in
\ref{chap3}. For the moment, however, let us turn to consider the stakes of the
visions we have seen. Why do these assumptions matter? And what
