...
technological peak---a number of identifiable sources for these ideological slants and
modes of rhetoric exist: science fiction, factory automation history,
...
itself \cite[p. 8]{wetmore}. But this work too is not often remembered.} that do filter through into the narratives of autonomous
technology \cite{CBSPetersen} include the 1939 World's Fair, discussed
...
from the 1950s are also occasionally remembered due to their publicity and
...
themselves engineering fictions. 
...
of bootstrapping information is data, ``Big'' and ``small.'' Today's
