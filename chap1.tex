...
the show did not actually envision driverless vehicles, get
remembered due to their flying cars, which trigger similar visions of wild
...
sense. They draw upon emotions, hopes, aspirations. Driverless cars
...
which can be photographed and written in. Special press events are hosted to allow journalists
to ride in these vehicles.\cite{???} Their capabilities touted,
advertised, but their media picture tightly controlled. Not subsumed
to the mundane, the quotidian, they still possess that magic that
makes science fiction connections obvious and compelling. But that
...
\subsection{Artificial Intelligence History}
