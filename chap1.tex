...
staple.\cite{scifiToReality} 

Many, indeed most, articles seem ignorant of the actual research
history. Some, especially from more scholarly establishments, bring up
...
goals of many news outlets interested primarily in pageviews.
...
through the media of popular culture and fiction. \emph{The Jetsons}, though
...
futures made possible through technology.\cite{JetsonsAge} GM's Firebird III, from a
...
to ride in these vehicles. Their capabilities are touted,
advertised, but their media picture is still tightly controlled. Not subsumed
to the mundane, the quotidian,\foonote{Certain articles from people
...
But the statements of researchers themselves are also responsible for
...
technology is broad indeed. Some are vehicle engineers, some of whom have been
interviewed or had their research papers picked up by news outlets.
Others are mathematicians and
computer scientists working on other problems related to
...
outlandish, like the works of science-fiction with which they have
been grouped here? Some of this has to do with other historical images
...
may have lost this romanticism, we haven't lost this perceived animism.
...
Norman writes in \emph{Things That Make Us Smart}---itself, a
statement reminiscent of recognitions by Ed
Hutchins's in his cognitive anthropology practice, particularly work
...
practice.\footnote{The Society of Automotive Engineers in particular
  ...
  progress or roadmap for development.}
...
human costs, and are unable to think beyond human-machine oppositions
parallel to those we have examined in automation and AI history.
...
driverless.\cite[p. 3]{NHTSA} According to their definition, Automated
...
driver input.''\cite[p. 3]{NHTSA} Therefore, the NHTSA definition excludes warning
...
human stewardship is necessary.\cite[p. 4--5]{NHTSA} This exposes naïve assumptions about
...
manual though never lingering in between.\cite[p. 4]{SAE} 
...
Additionally, both
taxonomies ignore the external labor involved in automation:
...
automated systems to operate? These are questions to which we will
return in chapters \ref{chap:chap2} and \ref{chap:chap3}. For the
moment, however, let us turn to consider the stakes of the
visions we have seen. Why do these kinds of assumptions matter? And what
