\chapter{Science Fictions, Designed Dreams}
\label{chap:2}
...
%% related to the technologies they are responsible for
%% helping bring to life on screen. 
...
%% in part because the visions are 
...
\section{The Stakes of Our Stories}
...
%% and seems to call to mind the famous failure of the
...
%% TODO: consider making this Stakes subsection, the overall title SF, DD
...
%% The EU ruling, in deference to European
...
%% having that information'' \cite{COJCosteja}.}
...
%%  Human understanding is built
%% through years of experience: i
...
Furthermore, the seemingly universalizing forces of maps tend to hide
...
%% \footnote{SRI's Shakey robot,
%%   discussed in chapter \ref{chap:1}, made navigation
%%   plans via rudimentary computer vision tools, specifically sonar
%%   range-finding.}

%% It is only relatively recently that real-time video
%% processing, needed for camera-based navigation, became feasible for computer
%% systems small enough to fit into a standard automobile \cite{vamors-p}.

%% not to achieve creative interpretation or aesthetic
%% valuation, but

%% (e.g. does the worm gear on an adjustable wrench count as a
%% separate object in addition
%% to the wrench itself?)
%% (e.g. a wrench)

For all this, however, vehicle localization and sensing depend upon
...
Vision is a particularly attractive sense to use in automated cars
...
situations. 
%% His take-away from these situations is that there 
%% is a significant body of edge-cases that make full autonomy
%% impractical for the foreseeable future. Instead,
...
\begin{figure}[h]
  \begin{center}
  \includegraphics{pedestriandetection}
  \end{center}
...
%% ---and
%% any claim that they ``know'' or ``understand'' is a misuse of words
...
%% is not ready for full-scale deployment. Make no mistake: c

%% It may be
%% that, for utilitarian 
%% purposes like driving, many characteristics of the human are
%% detrimental, their elimination helpful and intentional.
...
%% important for human acceptance of highly automated technologies. 
...
%% At this
%% stage in AI development, however, what we are truly discussing
When we
...
%% ; specifically, the poor safety record of human
%% drivers and the potential for machines to do much better, free from
%% human frailties of distraction and fatigue. T

The primary force in the current self-driving car
...
%% \footnote{As Jim Womack pointed out to me, there is no good side
...
%% according to FAA guidelines \cite[p. 39--40]{NRCAutonomy}.
...
%% centers with reduced potential for vibrant civic life \cite[p.
%% 60]{miaraBoston}.

%% INFORMANT
%% , and those of a fellow
%% researcher performing ethnographic work,
...
increases would be necessary to exceed the 
...
and just 8,000 for private cars.} Capacity estimates that assume 4
people per car would require  
significant changes in ride-sharing behavior to match in the real
world. Much depends on actual usage.
...
ameliorated, and significantly more environmental impact might result.
Any
...
%% \footnote{Adams
%%   and Brewer critique Intelligent Vehicle-Highways Systems as
...
%% which case vehicle usage would be expected to increase. This result
%% is

%% This question was in fact asked at the MIT SENSEable Cities
...
%% are not universal.
%% These utopian visions are not universal: a

%% Positive changes to city infrastructure will not happen
%% automatically.

%% would support fleets of
%% driverless taxis to move people around cities:  these concepts are
%% explicitly oriented toward providing for

%%  unable
%% to drive themselves home,

Increases in vehicle use are
...
%% While certainly not shared by
%% all developers in this space, it is not a vision we can afford.

%% Driverless vehicles stand to mean many things to many
...
%% and their
%% consequences. If we accept this narrative , what comes along for the ride?
...
troubling questions of machine capabilities and human-machine
relationships. 
