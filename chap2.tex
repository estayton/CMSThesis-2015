...
allow for a measure of tracking.\cite{???} Networked traffic cameras are
...
license plates.\cite{???} With sufficient coverage of cities and regions,
...
remains largely unregulated.\cite{???} California police are coming under
...
different, barring greater scrutiny and regulation.\cite{???}
...
harm.\cite{???-http://boingboing.net/2015/02/24/the-time-a-hacker-remotely-bri.html}
...
the horns
going.\cite{???-http://www.wired.com/2010/03/hacker-bricks-cars/} The
potential for this kind of access gets more frightening when one
considers the potential access a hacker or negligent employee might
have to an integrated, network-connected vehicle that is capable of
moving and navigating on its own.
