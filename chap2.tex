...
The stakes of autonomous vehicles are deeply intertwined with the
stakes of other networked technologies. In May of 2014, the European
...
open public removal of ``public'' information. But much of our
information is even harder to control.

All over data-driven business models\footnote{??? cite Google, other examples}, increases in
...
The paradox of information technologies that these cases dramatize is
of the utmost importance as computing technologies move deeper into
everyday devices. What is sensed, and what can be appropriately
...
commuting routes should never be collected, but that collected data
should not be sent uncritically to any third party without our
knowledge or consent, a violation of our information norms.\cite{???} There
...
authorities that might otherwise attempt to shut the service down.
...
needs to know where it is. Returning to the history of AI,
localization was part of the problem with the poor performance of the
robot Shakey: world modeling through a symbolic approach was slow.\cite{???}
Though one way to determine robot position in the world is through
simultaneous localization and mapping---a serious research area in
robotics, as it is ideal for areas that are impractical to map
beforehand\cite{???}---it is easier to localize by comparing
measurements to a known map. The subsumption architecture involved an
...
take advantage of new kinds of data.\cite{???}

<Find background on localization and mapping> <Comments about history of
localization, connect to the AI discussion,
going back to Shakey etc>
