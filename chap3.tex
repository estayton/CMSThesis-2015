...
autonomy not an ``inherent property of technology'' but ``a relation
between people, technology, and a task-environment'' (119)

While we might say ``\emph{Opportunity} encountered''
something,\cite[p. 8]{???-clancey} this
is really just convenient shorthand for scientists on Earth encountering it
through the telerobotic platform.

-sites of interest defined by human scientists, in contact at least
once if not more times per day.


Human common sense
is integral to rover missions, and organizations operating expensive
technology in a high-risk environment want humans to be responsible
