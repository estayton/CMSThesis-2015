...
%% Self-driving operation is considered---often via a
...
%%   disconnected from human oversight.}

% STAGE DIRECTION: rethinking the terms of what we have been talking
% about; we'll see that this narrative was always implicit but was
% being talked about as a failure not a strength

%% ---and all those we have investigated so far---

As we have seen, dominant automated car narratives rest on two primary,
...
%% Though work on such systems had been occurring
...
%% brought together into one source \cite[p. xix]{sheridan}.

%% Later human factors or \emph{ergonomics}
%% work continued to probe such questions, though m
%%  Though control researchers
%% interested in the behaviors of humans in interactions with highly
%% automated systems were already pursuing similar work, 
...
%%   factors in engineering culture is related.} 
...
requires. David Mindell,
  discussion with the author, September 8, 2014.} %% While the related
%% discipline of interaction design or 
...
%% dynamics of human and joint cognitive processes.
...
%% into the autonomous vehicle space, but 
...
%% view to encompass other related work.
%% 's ``How a Cockpit Remembers Its Speeds'' lays out a framework
%% for understanding the cognitive activities of a human-machine system,
%% and

%% \footnote{As he identifies,
...
%% about the point that the speed bugs and
%% other cockpit devices function as more than just memory aids for the
%% pilots. They
%% : specifically, changing a task that
...
%% I introduce this material here because
%% Hutchins, by looking at cognitive behaviors within this particular
%% setting,

%% Hutchins identifies a new unit of analysis:
%% the cockpit as a whole.

Hutchins is very particular that cockpit speed bugs do not na\"{\i}vely
...
%% the problem of so-called ironies of automation, whereby
%% It might
...
%% not with the concept of automation itself. But a

%% ---the system still ``knows'' how to turn, for
...
%%  and many automated vehicle systems involve
...
%% A number of levels-of-autonomy or
...
%% how automation research will progress. 
%% While they vary in terms of how
%% prescriptive or descriptive they are, t
...
%% These documents represent an important
%% vector for the traditional autonomous vehicle narrative, and are
%% therefore worthy of deeper scrutiny. present gaps in vision that echo the popular
%% narratives of automation and AI, and
...
The agency's definition also excludes non safety-critical ``control
...
% NEED TO TALK ATTENTION BEFORE THIS
%% \footnote{Attention and task hand-over are
...
%%   crash). This will be a particular focus in chapter \ref{chap:3}}
...
%% reinforces the
%% blindness to complex hybrid human-machine systems, and
...
%% Such a perspective tends to diminish the attention
%% paid to
...
%% Instead, autonomy in practice generally
%% involves subtasks, and novel mixes of human and computational effort,
%% not the wholesale transfer of a complete task or process.
...
% STAGE DIRECTION: role of these docs (as below); but when examined in
% the new light of a broader view that takes seriously human and
% machine, they are clearly lacking; where do we go from here? how do
% we more broadly reshape narratives around hybrid views of the human?
...
%% teleology is not supported by history. 
%% Furthermore, complete autonomy is
%% fundamentally a chimera, supported neither by history nor a close look
%% at the operations of actual devices.
...
%% distracted on the order of 10 seconds without causing a crash.
...
%%   contradiction. This idea also disregards 

One of many contradictions at the heart of
...
Supervisory control presents the possibility for a
