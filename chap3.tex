...
whenever possible \cite[p. 38]{PARCCAST}. This parallels some developments
...
book cited above as the bible for human supervisory control \cite[p. 23]{DSB}.
...
error.\footnote{This statistic seems warranted given recent NHTSA crash
  ...
  reasons'' involve driver error as a critical reason for the crash.
...
hijacked or stolen, the situation of the operator in is one of supervisory
