...
rockets. In a speech <FILL IN> <his quote about capabilities>.\cite{???}
...
airplane with you to be exposed to any adverse results.''\cite[p. 55]{???-DM}} <''Survival'' quotes about broken computers>\cite{???} From
...
supported some years later in <XXXX> by the flight of Valentina Tereshkova, the
...
the representatives of every-man and every-woman into space, but did
