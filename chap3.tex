...
many airlines 
actually have guidelines that require automation systems to be used
whenever possible\cite{???}. This actually parallels some developments
...
systems---are criticized by some as ``too easy to drive''\cite{???}.
...
may reduce attention and ability to react in an emergency situation.
Traction and stability control are now required for all cars in the US
market,\cite{???-brookings} while drivers' identities modulate the
