...
%% Does HSC section come before the history??

%%Subheads for domains

%%p 110: high performance racing pushing things? put in a little bit
...
the AI-focused perspective on automated systems.\footnote{Why is this
  ...
  factors in engineering is related.} This is neither a
...
%%TODO <??? Describe some from Sheridan 10-11 or run paragraphs together>
...
While the interface/UX-first approach of tech companies seems like it
...
is produced by an automatic guidance system'' \cite[p.
  129]{???-Klumpp}. Klumpp's self-described ``hybrid'' system account 
for the ``obvious desire of many man to control his craft'' and
...
\subsubsection{Unmanned Exploration and the Researcher}
...
skill\footnote{The navigation of human and automated capabilities in
  high-performance racing deserves proper investigation. But I suspect
...
http://recode.net/2015/03/17/google-self-driving-car-chief-wants-tech-on-the-market-within-five-years/
...
not culturally acceptable, to build one that is fully automated. While
