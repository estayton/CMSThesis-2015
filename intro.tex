...
Perhaps not. 
--would we accept a computer that kills 3000 to save 30000 that we
>kill?
--http://www.businessinsider.com/bill-gurley-is-skeptical-of-driverless-cars-2015-3
--http://www.washingtonpost.com/blogs/innovations/wp/2015/03/16/driverless-cars-a-tremendous-innovation-with-a-glaring-achilles-heel/
And soundbites from very respected autonomy researchers are used to
support this view: notably John Leonard, one of the researchers who
worked on MIT's entrant to the DARPA Urban Challenge\cite{???}.

excused for thinking this was just an argument between the
technophiles and naysayers, the daring dreamers versus the
conservative pragmatists. But there is much more to the story.
Both popular visions of this technology focus on the future, and do
relatively little to investigate the past or present, how we got to
where we are now, or even what level of autonomy we currently see in
our vehicles. 
HOWEVER, few people seem to dispute what the object is that is
...
>idea that ''if you are asked to take control, we've failed'' as a
culture of developers, more than just a risk-mitigation strategy (as
we will see, this view doesn't necessarily hold together given
historical examples)
