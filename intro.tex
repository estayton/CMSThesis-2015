...
information.\cite{???} This early experiment,
VaMoRs,\footnote{Versuchsfahrzeug f\"{u}r autonome Mobilit\"{a}t und
  Rechnersehen, or ``test vehicle for autonomous mobility and computer vision''} paralleled in the United 
...
part of the EUREKA PROMETHEUS\footnote{PROgraMme for a European
  Traffic of Highest Efficiency and Unprecedented Safety} project\cite{???}. The largest driverless vehicle
...
VITA\footnote{VIsion Technology Application} used
...
\cite{???-http://mobile.nytimes.com/2015/03/20/business/elon-musk-says-self-driving-tesla-cars-will-be-in-the-us-by-summer.html?\_r=0\&referrer=}.
