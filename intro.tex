...
like in 1960 \cite[p. 3-4]{wetmore}. Automobiles were still the focal
...
factory\footnote{A topic of public interest demonstrated through
...
New wartime and postwar developments in electronics, the same ones that
...
possible. In a lecture given in 1960, Wiener
...
that arguably began
with \emph{Safety Last} and \emph{Unsafe at Any Speed}
\cite{oconnellmyers} \cite{nader}---the public pushed
for an
increasing array of safety systems designed to make vehicles more forgiving
of human errors---starting with rudimentary
mechanical automation such as seat belts, and continuing through
airbags, ABS, and other more modern systems.
...
electronic tolls and driver information systems\footnote{411}, located
...
DARPA Grand Challenge in 2004 and 2005 (evolving from the
  DARPA Strategic Computing project, discussed in chapter
  \ref{chap:1}), and the DARPA Urban Challenge 
...
\section{Automated Cars in 2015}
...
This thesis is organized around investigating dominant narratives of
self-driving vehicles and their gaps. In chapter \ref{chap:1}, I continue examining
...
examine an alternative paradigm for thinking about automation, and
