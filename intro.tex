...
the CES 2015 vision, glitzy
--contrast with 1950s ad: non-obvious differences here, even what we
think we will USE these cars for has changed (family to work)

One popular vision of this technology focuses on the future: the
...
potentially short timescale.\cite{clytton}
Forbes article about Google's 5-year plan
--marketed w/o steering wheels
--outlaw drivers
--that these vehicles would operate on public roadways (which is NOT
stated here, and probably not true on this timescale, but seems
implied)
-in this vision, the law just needs to get out of the way, and
everyone's life could improve
...
>isn't there
-questions of safety? legality? insurance?
