...
automated vehicles. The cars' lateral position was maintained via
curved barriers that would restore the position of the cars using
...
\cite[p. 10]{wetmore}. Instead of autonomous vehicles we got a push
for an
...
airbags, ABS, and other more modern systems---that rose to public attention
with \emph{Safety Last} and \emph{Unsafe at Any Speed}
\cite{oconnellmyers} \cite{nader}. 
...
try to extend the capabilities of fully autonomous vehicles. The
...
apparent in this simplistic dual-narrative. Both popular visions of this
...
driving \cite{economistSR}---the latter largely stripped of its
 military valences. But these are generally subsumed by an imagined
 historical through-line. The nature of the self-driving car as it will appear in
the near future is not self-evident, however, no matter how loud Google's voice
or how large their investment.
 These technologies and visions of them
